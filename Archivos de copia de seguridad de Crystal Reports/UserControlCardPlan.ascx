...
<article runat="server" id="containerPlan" class="card card_plan flex-col flex-center-h gap-16">
    ...
    <asp:Button ID="btnGetPlan" runat="server" Text="" class="button" OnClick="btnGetPlan_Click"/>
