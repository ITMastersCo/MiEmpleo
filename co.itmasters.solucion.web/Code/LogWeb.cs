...
{
    public static class LogWeb
    {
        static readonly LogWriter logger;
        ...
        static LogWeb()
        {
            ...
            logger = new LogWriter(new ILogFilter[0], traceSources, nonExistantLogSource,  nonExistantLogSource,  mainLogSource,
                            "Error",false,  true);
        }
