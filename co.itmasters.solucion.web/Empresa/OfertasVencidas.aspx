                        ...
                        <Columns>
                            ...
                            <asp:TemplateField Visible="true">
                                <ItemTemplate>
                                    ...
                                    <asp:ImageButton ID="btnViewDetailOffer" runat="Server" Style="height: 25px; width: 25px;" CommandArgument="<% # Container.DataItemIndex %>" CommandName="VerDatos" ImageUrl="~/Images/ver.png" ToolTip="Ver oferta." OnCommand="btnViewDetailOffer_Command"/>
                                    <br />
