<%@ Page Title="Ofertas vencidas" Language="C#" MasterPageFile="~/ITMasters.Master" AutoEventWireup="true" CodeBehind="OfertasVencidas.aspx.cs" Inherits="co.itmasters.solucion.web.Empresa.OfertasVencidas" %>
                ...
                <div runat="server" id="detalleOferta" class="flex-col gap-32 w-100per">
                    ...
                    <div runat="server" id="containerCandidatos" class="flex flex-center bg-gray-100 overflow-y-scroll rounded relative"
                        ...
                        <div class="absolute" style="top: 0;">
                            <asp:GridView ID="grdCandidatos" runat="server" AutoGenerateColumns="false" class="flex-col flex-center gap-4 " PageSize="99999">
                                <Columns>
                                    <asp:TemplateField Visible="false">
                                        <ItemTemplate>
