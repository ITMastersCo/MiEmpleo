<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="404.aspx.cs" Inherits="co.itmasters.academics.web._404" %>
        ...
        <main>
            <section class="content">
                <div class="header-error">
                    <figure>
                        <asp:Image ImageUrl="~/Images/Error404.webp" runat="server" class="img-error" id="imgError"  alt="Error Image"/>
                    </figure>
                    <h1 class="cod-error text-bold" id="codError" runat="server">404</h1>
                </div>
                <article class="info-error">
                <h2 class="title-error text-bold text-title">  Página no encontrada</h2>
